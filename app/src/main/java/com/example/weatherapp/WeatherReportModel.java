...
public class WeatherReportModel {
    ...
    public void setWeather_state_name(String weater_state_name) {
        this.weather_state_name = weater_state_name;
    }
